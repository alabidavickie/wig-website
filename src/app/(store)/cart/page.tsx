    ...
    <div className="min-h-screen bg-background text-foreground font-sans" suppressHydrationWarning>
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-12 py-8 sm:py-12" suppressHydrationWarning>
        <header className="mb-8 sm:mb-12 md:mb-16 reveal">
          <h3 className="text-[9px] sm:text-[10px] font-bold uppercase tracking-[0.3em] md:tracking-[0.4em] text-muted-foreground mb-2 sm:mb-4">Your Selection</h3>
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-serif uppercase tracking-tighter italic leading-none text-foreground">Shopping <br /> Bag</h1>
        </header>
          ...
          <div className="grid lg:grid-cols-[1fr_450px] gap-10 md:gap-16 lg:gap-20">
            ...
            <div className="space-y-12">
              {items.map((item) => {
                ...
                return (
                  <div key={variantKey || item.id} className="reveal flex flex-col sm:flex-row gap-6 md:gap-10 group pb-12 border-b border-border last:border-0" suppressHydrationWarning>
                    <div className="w-full sm:w-32 md:w-48 aspect-[3/4] bg-card overflow-hidden shrink-0 rounded-[24px] md:rounded-[32px] border border-border shadow-sm transition-transform duration-500 group-hover:scale-[1.02] relative">
                    ...
                    <div className="flex-1 flex flex-col pt-0 sm:pt-4" suppressHydrationWarning>
                      <div className="flex justify-between items-start mb-6">
                        <div className="space-y-2">
                          <h3 className="text-[14px] font-bold uppercase tracking-[0.2em] text-foreground">{item.name}</h3>
                          {item.variant && (
                        ...
                        <button 
                          ...
                          className="w-10 h-10 flex items-center justify-center bg-[#2A2A2D] text-muted-foreground hover:bg-[#D5A754] hover:text-black transition-all rounded-full cursor-pointer"
                        >
                          <X className="w-4 h-4" />
                        </button>
                      </div>
            ...
            <div className="h-fit lg:sticky lg:top-[160px] reveal" suppressHydrationWarning>
               <div className="bg-card p-5 sm:p-6 md:p-10 space-y-6 sm:space-y-8 md:space-y-10 rounded-[24px] sm:rounded-[32px] md:rounded-[40px] border border-border shadow-2xl">
                ...
                <div className="pt-10 border-t border-border flex justify-between items-end">
                  <span className="text-[14px] font-bold uppercase tracking-[0.2em] text-foreground">Total Amount</span>
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-[10px] text-muted-foreground text-center uppercase tracking-[0.2em] font-bold leading-relaxed px-4">
