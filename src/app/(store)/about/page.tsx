  ...
  return (
    <div className="min-h-screen bg-background text-white font-sans">
      ...
      <section className="bg-[#0A0A0A] py-24">
        <div className="max-w-[1400px] mx-auto px-6 md:px-12">
          <p className="text-[10px] font-bold uppercase tracking-[0.5em] text-zinc-400 mb-4">The Visionary</p>
          ...
          <div className="grid md:grid-cols-[400px_1fr] gap-12 lg:gap-20 items-start">
            ...
            <div className="flex flex-col justify-center">
              <h3 className="text-[20px] font-bold uppercase tracking-widest text-white mb-1">Follienn</h3>
              <p className="text-[12px] text-[#D5A754] font-bold uppercase tracking-widest mb-8">Founder & CEO</p>
              <blockquote className="text-[16px] text-white/70 leading-[2] mb-10 border-l-2 border-[#D5A754] pl-8 italic">
              ...
              <a
                ...
                className="inline-flex items-center gap-3 text-[12px] font-bold uppercase tracking-widest text-white/60 hover:text-[#D5A754] transition-colors w-fit"
              >
      ...
      <section className="max-w-[1400px] mx-auto px-6 md:px-12 py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-10">
          {values.map((v) => (
            <div key={v.title} className="flex gap-6 items-start border-b border-[#2A2A2D] pb-10">
