  ...
  return (
    <div className="w-full max-w-5xl min-h-screen text-[#1A1A1D] bg-white mx-auto font-sans p-8 md:p-12">
      <header className="mb-20 reveal">
        <h3 className="text-[10px] font-bold uppercase tracking-[0.4em] text-[#1A1A1D]/40 mb-4">Security & Comfort</h3>
      ...
      <div className="space-y-20">
        ...
        <section className="reveal">
          <div className="flex items-center gap-4 mb-10">
            <h3 className="text-[11px] font-bold uppercase tracking-[0.4em] text-[#1A1A1D]/40">User Preferences</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10">
             <div className="flex items-center justify-between p-8 bg-[#FAF9F6] rounded-[32px] border border-gray-50 shadow-sm transition-all hover:shadow-xl">
                <div className="space-y-1">
                   ...
                   <p className="text-[11px] text-[#1A1A1D]/40 font-bold uppercase tracking-widest">Toggle Silk Haus Mode</p>
                </div>
             ...
             <div className="flex items-center justify-between p-8 bg-[#FAF9F6] rounded-[32px] border border-gray-100 shadow-sm transition-all hover:shadow-xl">
                <div className="space-y-1">
                   ...
                   <p className="text-[11px] text-[#1A1A1D]/40 font-bold uppercase tracking-widest">Notifications and Offers</p>
                </div>
                <Switch defaultChecked className="data-[state=checked]:bg-black data-[state=unchecked]:bg-gray-200" />
             </div>
             
             <div className="space-y-4">
                <Label className="text-[11px] font-bold uppercase tracking-widest text-[#1A1A1D]/40 ml-4">Currency Selection</Label>
             ...
             <div className="space-y-4">
                <Label className="text-[11px] font-bold uppercase tracking-widest text-[#1A1A1D]/40 ml-4">Preferred Language</Label>
        ...
        <section className="reveal">
          <div className="flex items-center gap-4 mb-10">
            <h3 className="text-[11px] font-bold uppercase tracking-[0.4em] text-[#1A1A1D]/40">Security Master</h3>
            <div className="flex-1 h-px bg-gray-100"></div>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
             <div className="space-y-4">
                <Label className="text-[11px] font-bold uppercase tracking-widest text-[#1A1A1D]/40 ml-4">Current Password</Label>
             ...
             <div className="space-y-4">
                <Label className="text-[11px] font-bold uppercase tracking-widest text-[#1A1A1D]/40 ml-4">New Password</Label>
             ...
             <div className="space-y-4">
                <Label className="text-[11px] font-bold uppercase tracking-widest text-[#1A1A1D]/40 ml-4">Confirm New Password</Label>
