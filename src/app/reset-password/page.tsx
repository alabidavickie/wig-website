  ...
  return (
    <div className="min-h-screen bg-background flex flex-col justify-center py-12 px-6 lg:px-8 font-sans">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        ...
        <h2 className="text-[14px] uppercase tracking-widest font-bold text-foreground">Reset Password</h2>
        ...
        <div className="bg-card py-8 px-4 border border-border sm:px-10">
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="space-y-2">
              <Label className="text-[10px] uppercase tracking-widest text-muted-foreground font-bold" htmlFor="password">New Password</Label>
              <Input
                id="password"
                name="password"
                type="password"
            ...
            <div className="space-y-2">
              <Label className="text-[10px] uppercase tracking-widest text-muted-foreground font-bold" htmlFor="confirmPassword">Confirm Password</Label>
              <Input
                id="confirmPassword"
